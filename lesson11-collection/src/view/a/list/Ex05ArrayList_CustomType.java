...
public class Ex05ArrayList_CustomType {
	public static void main(String[] args) {
		...
		Item itemToBeRemoved = new Item(1, "Item A1", bd(228), 101);
		items.remove(itemToBeRemoved);
		items.forEach(System.out::println);
		
		
		System.out.println("\n Test contains(item 1) --> " + items.contains(itemToBeRemoved));
		System.out.println("\n Test Sorting Storeld ASC, SalesPrice DESC ... \n");

		// item -> item.getStoreld() <==> Item: :getStoreld 
