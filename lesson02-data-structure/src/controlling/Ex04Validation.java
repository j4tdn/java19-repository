...
public class Ex04Validation {
	public static void main(String[] args) {
		...
		// + Nhập số nhưng người dùng nhập chữ, ký tự đặc biệt
		...
		// kiểm tra hợp lệ, có phải là chuỗi số hay ko
		// 15 --> ok
		// a333n --> fail --> a333n --> length = 5
		//                    01234 --> chỉ số vị trí của kí tự trong chuỗi
		// 444 --> ok
		// yyyy --> fail
		do {
		...
		// ==> exception(ngoại lệ) là những lỗi ko mong muốn khi thực thi chương trình
		// JAVA sẽ tự động quăng ngoại lệ này ra yêu cầu người dùng thực hiện đúng
		
		// Xử lý: trước khi convert(chuyển đổi) giá trị nhập vào sang int
		// phải kiểm xem giá trị nhập vào đó có phải là 1 dãy số ko
