...
public class Ex01BasicDemo {
	public static void main(String[] args) {
		...
		//Giá trị lưu ở vùng  nhớ HEAP --> constant pool
		Integer oA = 66;//H9 -->oA.value = 66
		...
		// kiểm tra trong vùng nhớ constrant pool đã có giá trị
		// mới đó chưa
		//+ nếu chưa --> tạo mới
		//+ có ròi --> không tạo mới mà trỏ để ô nhớ đã có giá trị đó
		...
		//--> số millis tính từ epoch time(mốc thời gian) 1.1.1970
