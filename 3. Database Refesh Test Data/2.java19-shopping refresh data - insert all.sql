...
SELECT 1 ID, 'Chờ xác nhận' `DESC` 	UNION
...
-- scope: in sql query start until (in sql query) 
...
(
SELECT 1,	'Bộ phận nhân sự' UNION
SELECT 2,	'Bộ phận bán hàng' UNION
SELECT 3,	'Bộ phận giao hàng' UNION
SELECT 4,	'Bộ phận giám sát' UNION
SELECT 5,	'Bộ phận quảng cáo'
);

INSERT INTO ITEM(ID, `NAME`, MATERIAL, BUY_PRICE, COLOR, ITEM_GROUP_ID)
VALUES 
	(	1,	'Áo 1',		'Chất Liệu 1',		'195',	'Trắng',	1),
