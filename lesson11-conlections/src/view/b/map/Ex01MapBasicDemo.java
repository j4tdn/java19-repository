...
public class Ex01MapBasicDemo {
	...
	public static void main(String[] args) {
		...
		vehicleModelMap.put(43, "ĐN");// THAY "Đà Nẵng"
		vehicleModelMap.putIfAbsent(92, "Quảng Nam");//Giữ Nguyên
		
		vehicleModelMap.remove(43);//xoá (43, "Đà Nẵng")
		vehicleModelMap.put(73, "Quảng Bình");
		
		printf("vehicleModelMap", vehicleModelMap);
		System.out.println("map contains --> " + vehicleModelMap.containsKey(92));
		System.out.println("map get --> " + vehicleModelMap.get(92));
