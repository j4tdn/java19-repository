...
public class WeekDayCalculator {
	public static void main(String[] args) {
		Date date = parseDateFormat("Date", "dd,MM,yyyy",2);
		Calendar calendarAsDate = createCalendarAsDate(date);
		DateFormat df = new SimpleDateFormat("dd MMMM yyyy");
		String dayOfWeekAsText = getDayOfWeekAsText(calendarAsDate);
		System.out.println(df.format(date) + " is a " +  dayOfWeekAsText);
		...
		System.out.println(" . It is " + dayOfWeekAsText + " number " + getActualMaximumCurrentDayOfWeekInYear(calendarAsDate)[0] 
										+ " out of " + getActualMaximumCurrentDayOfWeekInYear(calendarAsDate)[1] 
										+ " in " 	 + getActualMaximumCurrentDayOfWeekInYear(calendarAsDate)[2]);
		
		System.out.println(" . It is " + dayOfWeekAsText + " number " + getActualMaximumCurrentDayOfWeekInMonth(calendarAsDate)[0] 
