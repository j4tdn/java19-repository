...
public class PolymorphismDemo {
	public static void main(String[] args) {
		...
		// lơp con ko bắt buộc phải override các phương thức lop cha
		...
		// s1 --> rectangle
		// s2 --> square
		// s1 có 4 cạnh bằng nhau --> square --> s1.calArea() --> s1 gọi hàm tính diện
		// tích
		...
		// 2. Tham số KDL cha có thể nhận than số KDL con khi truyền tham số
		// (PolymorphismPassingParameterDemo)
		...
		// cha, con(s) --> muốn khởi tạo đối tượng --> cha new con --> để có thể sử 1 2
		// 3 phía trên
