...
/**
 * LocalDate: d/M/y DateTimeFormatter
 */
public class Ex02LocalDateDemo {
	public static void main(String[] args) {
		...
		ldate = ldate.withDayOfMonth(2).withMonth(2).with(ChronoField.YEAR, 2024).plusYears(1); // 02/03/2023
		...
		System.out.println("period toString: \n" + optional(period.getYears(), "year")
				+ optional(period.getMonths(), "month") + optional(period.getDays(), "day"));
	}
